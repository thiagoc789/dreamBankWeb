			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dreambankv2-display": {
								"semanticObject": "dreambankv2",
								"action": "display",
								"description": "Banco de becas ",
								"title": "DreamBank",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dreambankv2",
									"url": sap.ui.require.toUrl("dreambankv2")
								}
							}
						}
					}
